...
@pytest.fixture(scope="session")
def salt_minion_factory(request, salt_master_factory):
...
@pytest.fixture(scope="session")
def salt_sub_minion_factory(request, salt_master_factory):
    with salt.utils.files.fopen(
...
@pytest.fixture(scope="session")
def salt_proxy_factory(request, salt_factories, salt_master_factory):
